...
import { loadProtos, ProtoFile, ProtoService } from '../../api';
...
export function App({ defaultProtos }: AppProps) {
    ...
    if (savedEditorTabs) {
      hydration.push(
        loadTabs(savedEditorTabs)
          ...
          .then((tabs) => setEditorTabs(tabs as EditorTabs))
          .then(() => true)
      );
    }
  }
